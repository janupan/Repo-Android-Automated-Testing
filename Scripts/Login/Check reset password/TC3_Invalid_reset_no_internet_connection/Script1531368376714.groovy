...
Mobile.setText(findTestObject('android.widget.EditText0 - Please write your email... (2)'), 'gio@mailinator.com', 0)

Mobile.tap(findTestObject('android.widget.TextView1 - Confirm (2)'), 0)
